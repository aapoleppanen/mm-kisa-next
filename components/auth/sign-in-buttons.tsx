    ...
    <div className="flex flex-col gap-4 w-full max-w-sm">
      ...
      <div className="flex flex-col gap-2">
        <Button
          ...
          variant="outline"
          className="gap-2.5 w-full rounded-xl border-border/80 text-slate-700 hover:bg-slate-50 hover-lift active-press"
        >
          <Github size={16} />
        ...
        <Button
          ...
          variant="outline"
          className="w-full gap-2.5 rounded-xl border-border/80 text-slate-700 hover:bg-slate-50 hover-lift active-press"
        >
